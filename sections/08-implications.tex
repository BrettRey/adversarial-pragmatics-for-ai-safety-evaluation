...
In secure-delegation terms, the benchmark does not claim to solve the whole control problem. It supplies one measurement layer that such a program needs: evidence about whether instruction status, authority, scope, and failure attribution remain stable under adversarial language conditions.

...
The current seed P008 is excluded from strict-pair scoring because it doesn't meet those conditions; the development set should replace it with two clean contrast pairs.

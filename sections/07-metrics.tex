...
response change, as in the Study A seed re-adjudication, panel-outcome
...
Adjudication stability asks whether expert evaluators apply the item metadata and rubric consistently. Any released benchmark label retains that provenance. Report repeat stability, intervention rate, criterion conflicts, and taxonomy revisions against the fake-data expectations set before the development pass.

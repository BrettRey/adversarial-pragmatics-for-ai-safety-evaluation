...
The benchmark reports a vector of eight metric families. Each is reported by phenomenon family, application surface, criterion, and named configuration before any decision-specific aggregation is considered.
...
A reference claim concerns the licensed-action relation generated by a frozen stipulated-regime template and output-blind adjudication procedure. A behavioural claim concerns one versioned evaluation-configuration family, including its enumerated wrappers and context-assembly rules. A measurement claim concerns one versioned scorer, codebook, implementation, adjudication procedure, criterion semantics, and predeclared prompt and evidence-access perturbations. A taxonomic claim concerns one versioned taxonomy and assignment procedure. Each has its own target, tolerance, evidence, and revision rule in the Study~B claim register.

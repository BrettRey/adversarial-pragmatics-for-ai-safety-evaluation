...
3. Annotation protocol: rater roles, gold labels, confidence, disagreement, and adjudication.
4. Scoring framework: diagnostic ambiguity, taxonomy drift, source sensitivity, mention/use robustness, scope robustness, and rater-role divergence.
...
Create a 50--100 item pilot benchmark from the seed schema, run a small annotation pass, and use the disagreement profile to revise the taxonomy before scaling toward 300--800 items.

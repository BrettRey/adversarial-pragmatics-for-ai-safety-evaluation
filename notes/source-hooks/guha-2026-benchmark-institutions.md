...
**Source chain, traced 2026-07-26** (full table in the central note). The 33% figure comes from Magesh, Surani, Dahl, Suzgun et al., "Hallucination-Free? Assessing the Reliability of Leading AI Legal Research Tools," *Journal of Empirical Legal Studies* 22, 216-242, DOI `10.1111/jels.12413`, published 2025. Guha et al.'s own reference list dates it 2024 and is wrong; use 2025. Hidden stratification is Oakden-Rayner, Dunnmon, Carneiro & Ré, ACM CHIL 2020, 151-159. **The Paxton press release is uncited in Guha et al.**, so if AP uses that case the press release has to be found independently.

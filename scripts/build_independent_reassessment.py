...
def write_role_readme(
    ...
    *,
    ...
    path.write_text(
        ...
        "until you download the response JSON. Plan for approximately 30–40 minutes for this "
        "18-row block; that is an administrative estimate, not a target or performance measure. "
        "The downloaded file includes coarse block timestamps for saving and return validation; "
        "those fields are excluded from Study A analysis. Do not enter a real name or private "
        "information.\n"
        + self_pilot_note,
        encoding="utf-8",
    )

...
- people with expertise in linguistics, pragmatics, discourse, language
  analysis, or closely related research methods; and
- people able to assess stated policy, safety, or agent-use constraints without
  treating the exercise as a general model-ranking task.
...
To express possible interest once the study is live, contact: **[Brett's chosen
study contact route]**.

...
\node[font=\tiny, align=center, text=linkmaroon] at (1.45,-3.25) {local, cumulative, and terminal\\conditions evaluated over history};
\end{scope}
\end{tikzpicture}
